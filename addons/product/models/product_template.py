...
class ProductTemplate(models.Model):
    ...
    inventory_value = fields.Float(
        'inventory value', default=1.0, digits=dp.get_precision('Product Price'))
    volume = fields.Float(
    ...
    @api.onchange('inventory_value')
    def _onchange_inventory_value(self):
        self.list_price = self.inventory_value + self.standard_price
